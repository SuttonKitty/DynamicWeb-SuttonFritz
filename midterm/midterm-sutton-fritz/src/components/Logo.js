const Logo = () => {
  return (
    <div class="logo flex flex-col">
        <a href="../app" className="p-[0.1rem] flex flex-col text-[#BF092F] text-[1rem] w-[2.5rem] text-justify border-double  border-[0.3rem] border-[#BF092F] rounded-[1rem] fixed top-[1rem] right-[3%] hover:text-[#FAF8F1] hover:border-[#FAF8F1] hover:bg-[black]">
            {/* make this grid */}
            s u<br />t t<br />o n
        </a>
        {/* add auto scroll on hover but back when not on hover but stay on cick */}
        ...
        {/* <div className="focus:outline focus:outline-[black]"> */}
          ...
          <a href="../app" className="p-[0.1rem] flex flex-col text-[black] text-[1rem] w-[2.5rem] text-justify underline decoration-dotted  underline-[#BF092F] rounded-[1rem] fixed top-[25rem] right-[2.5%] hover:text-[#BF092F] hover:underline-[#FAF8F1]">
              N°6
          </a>
          <a href="../app" className="p-[0.1rem] flex flex-col text-[black] text-[1rem] w-[2.5rem] text-justify underline decoration-dotted  underline-[#BF092F] rounded-[1rem] fixed top-[28rem] right-[2.5%] hover:text-[#BF092F] hover:underline-[#FAF8F1]">
              N°7
          </a>
          <a href="../app" className="p-[0.1rem] flex flex-col text-[black] text-[1rem] w-[2.5rem] text-justify underline decoration-dotted  underline-[#BF092F] rounded-[1rem] fixed top-[31rem] right-[2.5%] hover:text-[#BF092F] hover:underline-[#FAF8F1]">
              N°8
          </a> */}
        {/* </div> */}
    </div>
